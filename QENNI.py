...
# Date    2015-01-03
# Description:
# QENNI(quadrant encapsidated nearest based imputation)
#
#
from numpy import *
import matplotlib
...
if __name__ == '__main__' :
    ...
    resultData, p_choose, dist_weight, numOfEachQuadrant, volumeOfEachQ  = qenni_impl(iDataSet, cDataSet)
